...
**Pair with:** a `telnyx` provider for the brain (`crates/core/zeroclaw-providers/src/telnyx.rs`) and ensure your Telnyx account has a SIP connection with the correct webhook URL pointed at the ZeroClaw gateway.
